-- =============================================================================
-- Runnit :: 63. evaluate_badge_condition 앵커 치환 패치 회귀 가드 (R-12)
-- -----------------------------------------------------------------------------
-- 번호 이력: 원래 62 로 작성·적용됐으나(원격 schema_migrations version
-- 20260902072940), 병렬 세션의 `leaderboard_entries_active` 뷰가 같은 62 를
-- 선점해 파일명 충돌이 났다. 파일은 63 으로 재번호했다(원격 이력은 그대로).
-- -----------------------------------------------------------------------------
-- 배경
